...
boxplot_file('cpi_peptide_macc.data',
             'testResult_peptide_macc.data',
             'gpcr peptide macc')
### test tkl
boxplot_file('cpi_kinase_all_tkl_fingerprint.data',
             'testResult_kinase_all_tkl_fingerprint.data',
             'kinase all tkl fingerprint')
boxplot_file('cpi_kinase_tkl_fingerprint.data',
             'testResult_kinase_tkl_fingerprint.data',
             'kinase pre tkl fingerprint')
boxplot_file('cpi_kinase_stt_tkl_fingerprint.data',
             'testResult_kinase_stt_tkl_fingerprint.data',
             'kinase stt tkl fingerprint')
